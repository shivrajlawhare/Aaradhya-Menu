...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col items-center  bg-brand-bg px-4">
      <img src="/logo.png" alt="Hotel Logo" className="w-80 h-36 mb-4" />
      <h1 className="text-2xl mb-10 text-brand-text font-bold">Welcome to Aardhya</h1>
